	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		try {
			...
			if (!studentLoginId.equals("")) {
				...
				colLNum.setPrefWidth(100);
				colLNum.setStyle("-fx-alignment:CENTER");
				colLNum.setCellValueFactory(new PropertyValueFactory<>("t_section"));

				TableColumn colTDate = new TableColumn("등록날짜");
				colLNum.setPrefWidth(160);
				colLNum.setStyle("-fx-alignment:CENTER");
				colLNum.setCellValueFactory(new PropertyValueFactory<>("t_date"));
	...
	public void handlerBtnTraineeInsertAction(ActionEvent event) {
		try {
			...
			if (tdao != null) {
				...
				alert.setContentText("다음 과목 수강 신청을 하세요.");
				alert.showAndWait();
