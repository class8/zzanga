...
public class TradeDAO {
	...
	public ArrayList<TradeVO> getTradeCheck(String name, String startdate, String enddate) throws Exception {
		...
		String sql = "select t_number,f_number,c.c_number,c_name,t_amount,t_price,t_deposit,t_penalty,t_balance,t_receipt,t_unpaid,t_status,c_phone,t_registdate,t_address,t_remarks from trade t, customer c where t.c_number=c.c_number and t_registdate>? and t_registdate<? and c_name like ? order by t_number";
